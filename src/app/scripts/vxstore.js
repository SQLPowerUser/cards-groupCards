export default {
	state: {
		...
		task: {
			1: { groupID: 2, name: 'Защитить исследовательский Центр Парения,\nосвободить комплекс по добыче воды,\nуничтожить все военные базы Империи и Стража Свободы', isComplete: false },
